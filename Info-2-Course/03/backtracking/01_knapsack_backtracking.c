...
/* Untersucht, ob eine Fuellung des Rucksacks mit
   ...
   Gewinn fuehren kann. x[ 1 .. i-1 ] ist der bereits
   festgelegte Teil der gerade betrachteten Fuellung
   ( x[ i ] = 1(0) heisst, dass Gegenstand i (nicht) 
   mitgenommen wird ), g_x und v_x der zu dieser
   Teilfuellung gehoerige Gewinn bzw. das Volumen, 
   g_rest der durch Mitnahme aller restlichen 
   Gegenstaende i .. n erzielbare Gesamtgewinn.
